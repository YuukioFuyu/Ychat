...
// Database username:
$config['dbConnection']['user'] = ''; //<---YOUR DB ROOT USERNAME
// Database password:
$config['dbConnection']['pass'] = ''; //<---YOUR DB PASSWORD
// Database name:
$config['dbConnection']['name'] = ''; //<---YOUR DB NAME
// Database type:
...
$config['dbTableNames']['online']		= 'ychat_online';
$config['dbTableNames']['messages']		= 'ychat_messages';
$config['dbTableNames']['bans']			= 'ychat_bans';
$config['dbTableNames']['invitations']	= 'ychat_invitations';
...
// Available styles:
$config['styleAvailable'] = array('Ychat');
// Default style:
$config['styleDefault'] = 'Ychat';
...
$config['requestMessagesTimeDiff'] = 168;
