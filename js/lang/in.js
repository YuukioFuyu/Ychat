...
var ajaxChatLang = {
	...
	logoutTimeout: '%s telah keluar dari saluran (Waktu Habis).',
	logoutIP: '%s telah keluar dari saluran (Alamat IP Tidak Valid).',
	logoutKicked: '%s telah keluar dari saluran (Dikeluarkan Admin).',
	channelEnter: '%s masuk saluran.',
	channelLeave: '%s meninggalkan saluran.',
	privmsg: '(Ping)',
	privmsgto: '(Mengirim Pesan Pribadi ke %s)',
	invite: '%s mengundang kamu untuk gabung ke %s.',
	inviteto: 'Undangan kamu ke %s untuk gabung saluran %s telah dikirim.',
	uninvite: '%s membatalkan untuk mengundang kamu dari saluran %s.',
	uninviteto: 'Pembatalan undangan kamu ke %s untuk salura %s telah dikirim.',	
	...
	errorInviteNotAllowed: 'Error: Kamu tidak diijinkan untuk mengundang orang lain ke saluran ini.',
	errorUninviteNotAllowed: 'Error: Kamu tidak diijinkan untuk tidak mengundang seseorang ke saluran ini.',
	errorNoOpenQuery: 'Error: Tidak ada saluran privasi yang dibuka.',
	errorKickNotAllowed: 'Error: Kamu tidak diijinkan untuk menendang %s.',
	errorCommandNotAllowed: 'Error: Perintah tidak diijinkan: %s',
	errorUnknownCommand: 'Error: Perintah tidak diketahui: %s',
	errorMaxMessageRate: 'Error: Kamu telah melampaui batas pesan maksimum per menitnya.',
